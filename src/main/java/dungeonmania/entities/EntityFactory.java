...
import dungeonmania.entities.overlappableEntities.Boulder;
import dungeonmania.entities.overlappableEntities.Door;
import dungeonmania.entities.overlappableEntities.Player;
import dungeonmania.entities.overlappableEntities.Portal;
import dungeonmania.entities.overlappableEntities.collectables.*;
import dungeonmania.entities.overlappableEntities.collectables.potions.InvincibilityPotion;
import dungeonmania.entities.overlappableEntities.collectables.potions.InvisibilityPotion;
import dungeonmania.entities.overlappableEntities.enemies.*;
...
public class EntityFactory implements Serializable {
    ...
    public void spawnSpider(Game game) {
        ...
        game.register(() -> spider.move(map), Game.AI_MOVEMENT, spider.getId());
    }
    ...
    public void spawnZombie(Game game, ZombieToastSpawner spawner) {
        ...
        map.addEntity(zt);
        game.register(() -> zt.move(map), Game.AI_MOVEMENT, zt.getId());
    }
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double assassinFailRate = config.optDouble("assassin_bribe_fail_rate", Assassin.DEFAULT_BRIBE_FAIL_RATE);
