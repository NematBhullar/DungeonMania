...
public class Game implements Serializable {
    ...
    public Game tick(Direction movementDirection) {
        ...
        registerOnce(() -> player.onTickSceptre(tickCount, map), PLAYER_MOVEMENT, "playerUsesItem");
        tick();
        return this;
    }

    public Game tick(String itemUsedId) throws InvalidActionException, IllegalArgumentException {
