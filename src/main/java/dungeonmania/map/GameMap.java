...
import dungeonmania.entities.overlappableEntities.enemies.DestroyableEntity;
...
import dungeonmania.entities.overlappableEntities.movedAwayEntities.MovedAwayEntity;
...
public class GameMap implements Serializable {
    ...
    private void initRegisterMovables() {
        ...
        enemies.forEach(e -> {
            game.register(() -> e.move(map), Game.AI_MOVEMENT, e.getId());
        });
    }
    ...
    private void triggerMovingAwayEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e instanceof MovedAwayEntity)
                callbacks.add(() -> ((MovedAwayEntity) e).onMovedAway(this, entity));
        });
    ...
    private void triggerOverlapEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e instanceof OverlappableEntity)
    ...
    public void destroyEntity(Entity entity) {
        ...
        if (entity instanceof DestroyableEntity) {
            ((DestroyableEntity) entity).onDestroy(this.getGame());
        }
    }
